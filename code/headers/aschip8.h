...
public:
  ...
  /*8xy2 - AND Vx, Vy
     ...
     values, and if both bits are 1, then the same bit in the result is also 1.
     Otherwise, it is 0.*/
  ...
  /*8xy4 - ADD Vx, Vy
     ...
     than 8 bits (i.e., > 255,) VF is set to 1, otherwise 0. Only the lowest 8
  ...
  /*Dxyn - DRW Vx, Vy, nibble
     ...
     VF = collision. The interpreter reads n bytes from memory, starting at the
     address stored in I. These bytes are then displayed as sprites on screen at
